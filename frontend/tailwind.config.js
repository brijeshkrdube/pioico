    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                ...
                'obsidian-shine': 'linear-gradient(180deg, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0) 100%)',
                'gold-glow': 'radial-gradient(circle at center, rgba(212, 175, 55, 0.15) 0%, rgba(0,0,0,0) 70%)',
            },
        }
    },
